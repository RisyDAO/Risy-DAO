var data = {
  "common": {
    "config": {
      ...
      "mirrors": [
        ...
        { name: 'IPFS Mirror', url: 'https://ipfs.io/ipfs/bafybeidmfyecpbodyjantwmkiye24am25ykct3qbx7yasd3fey5xpdhcsi' },
        { name: "RISY's Gate IPFS Mirror", url: 'https://b3ca46df0ceff8a786448cd755b79a9c.ipfscdn.io/ipfs/bafybeidmfyecpbodyjantwmkiye24am25ykct3qbx7yasd3fey5xpdhcsi' },
        { name: 'DWeb IPFS Mirror', url: 'https://dweb.link/ipfs/bafybeidmfyecpbodyjantwmkiye24am25ykct3qbx7yasd3fey5xpdhcsi' },
        { name: 'FLK-IPFS Mirror', url: 'https://bafybeidmfyecpbodyjantwmkiye24am25ykct3qbx7yasd3fey5xpdhcsi.ipfs.flk-ipfs.xyz' }
      ]
    },
  },
  "en": {
    ...
    "onChainData": {
      ...
      "minute": "m",
      "second": "s",
      "fetchError": "Failed to fetch on-chain data.<br>Please check your network connection.<br><br>Trying again in 5 seconds or refresh page...",
    ...
    "about": {
      ...
      "description4": "We address the centralization problem of cryptocurrencies, whale manipulations, and unfair distribution of tokens through Risy DAO Token (RISY)'s innovative 10% daily transfer limit and temporary 0.75% (~=7500000000 RISY) hodl limit during the ICO period. This Initial DEX Offering (iDEXo) model ensures a fair distribution, balancing advantages for early investors while protecting new investors. The project evolves and upgrades itself indefinitely thanks to the DAO mechanism, ensuring long-term sustainability and adaptability.",
    ...
    "features": [
      ...
      },
      {
        ...
        "description": "Fully managed by the DAO, ensuring no single entity has disproportionate control."
      },
      {
        "icon": "fa-shield-alt",
      ...
      },
      {
        ...
        "title": "Scalability",
        "description": "Built on Polygon for fast and cost-effective transactions and dApp development."
      },
      {
        "icon": "fa-code-branch",
        "title": "Continuous Improvement",
        "description": "DAO mechanism allows the project to evolve and upgrade based on community decisions."
      }
    ],
    "tokenomics": {
    ...
    "faq": {
      ...
      "items": [
        ...
        {
          "question": "What makes Risy DAO different from other cryptocurrencies?",
          "answer": "Risy DAO is correlated with both USD and gold, providing stability against various market conditions. It's built on the Polygon blockchain for fast and affordable transactions, and it has a self-sustaining model with a 0.1% DAO fee on transfers.",
          "isOpen": false
        },
        {
          "question": "How can I participate in Risy DAO governance?",
          "answer": "As a RISY token holder, you can participate in governance by voting on proposals and creating new proposals if you meet the required threshold. The DAO mechanism allows the project to evolve based on community decisions.",
          "isOpen": false
        },
        {
        ...
        {
          "question": "How does Risy DAO ensure fair distribution during the ICO?",
          "answer": "Risy DAO implements an Initial DEX Offering (iDEXo) model with whale protection mechanisms to ensure fair distribution. The 10% daily transfer limit and temporary 0.75% hodl limit during the ICO period prevent large-scale accumulation by whales. This approach balances the advantages for early investors while protecting the rights of new investors, creating a more equitable distribution of tokens.",
          "isOpen": false
        }
      ]
    },
  ...
  "tr": {
    ...
    "onChainData": {
      ...
      "minute": "d",
      "second": "sn",
      "fetchError": "Zincir üstü veriler alınamadı.<br>Lütfen ağ bağlantınızı kontrol edin.<br><br>5 saniye içinde tekrar denenecek veya sayfayı yenileyin...",
      "loading": "Zincir üstü veriler yükleniyor...",
    ...
    "about": {
      ...
      "description4": "Risy DAO Token (RISY)'ın yenilikçi %10 günlük transfer limiti ve ICO döneminde geçici %0.75 (~=7500000000 RISY) hodl limiti sayesinde kripto paraların merkezileşme sorununu, balina manipülasyonlarını ve token'ların adil olmayan dağıtımını ele alıyoruz. Bu Başlangıç DEX Teklifi (iDEXo) modeli, erken yatırımcılar için avantajları dengelerken yeni yatırımcıları da koruyarak adil bir dağıtım sağlıyor. Proje, DAO mekanizması sayesinde süresiz olarak evrilip yükseliyor ve bu da uzun vadeli sürdürülebilirlik ve uyarlanabilirlik sağlıyor.",
    ...
    "features": [
      ...
      },
      {
        ...
        "description": "Tamamen DAO tarafından yönetilir, hiçbir kuruluşun orantısız kontrole sahip olmamasını sağlar."
      },
      {
        "icon": "fa-shield-alt",
        "title": "Balina Koruması",
      ...
      },
      {
        ...
        "description": "Hızlı ve uygun maliyetli işlemler ve dApp geliştirme için Polygon üzerine inşa edilmiştir."
      },
      {
        "icon": "fa-code-branch",
        "title": "Sürekli İyileştirme",
        "description": "DAO mekanizması, projenin topluluk kararlarına göre gelişmesine ve yükseltilmesine olanak tanır."
      }
    ],
    "tokenomics": {
      ...
      "items": [
        ...
        "Başlangıç Likiditesi: 20,000$ (%50 USDC, %50 PAXG)",
        "DAO Ücreti: Her transferde %0.1",
      ...
      "items": [
        {
          "quarter": "2024 Q3",
          "items": [
            "Polygon ana ağında Risy DAO ve RISY token'ın lansmanı",
            "İlk DEX tekliği (IDO) ve likidite sağlanması",
            "Yönetişim platformunun lansmanı"
          ]
        },
        {
          "quarter": "2024 Q4",
          "items": [
            "İlk topluluk yönetişim önerileri",
            "İlk dApp prototiplerinin geliştirilmesi",
            "Diğer blok zinciri projeleriyle stratejik ortaklıklar"
          ]
        },
        {
          "quarter": "2025 Q1",
          "items": [
            "İlk Risy DAO destekli DeFi uygulamasının lansmanı",
            "Büyük cüzdanlar ve borsalarla entegrasyon",
            "Oyun ekosisteminin geliştirilmeye başlanması"
          ]
        },
        {
          "quarter": "2025 Q2",
          "items": [
            "Zincirler arası köprüleme çözümlerinin tanıtılması",
            "Topluluk odaklı projeler için Risy DAO kuluçka merkezinin başlatılması",
            "Yönetişim yeteneklerinin genişletilmesi"
          ]
        }
      ]
    },
    "faq": {
      ...
      "items": [
        ...
        {
          "question": "Risy DAO'yu balina manipülasyonunu nasıl önlüyor?",
          "answer": "Risy DAO, balinalar tarafından büyük ölçekli piyasa manipülasyonunu önlemek için %10'luk günlük transfer limiti ve ICO döneminde geçici %0.75'lik hodl limiti uygulamaktadır.",
          "isOpen": false
        },
        {
          "question": "Risy DAO'yu diğer kripto paralardan farklı kılan nedir?",
          "answer": "Risy DAO, hem USD hem de altınla korelasyon içindedir ve bu sayede çeşitli piyasa koşullarına karşı istikrar sağlar. Hızlı ve uygun maliyetli işlemler için Polygon blok zinciri üzerine inşa edilmiştir ve transferlerde %0.1'lik DAO ücreti ile kendi kendini sürdüren bir modele sahiptir.",
          "isOpen": false
        },
        {
          "question": "Risy DAO yönetimine nasıl katılabilirim?",
          "answer": "RISY token sahibi olarak, önerilere oy vererek ve gerekli eşiği karşılıyorsanız yeni öneriler oluşturarak yönetime katılabilirsiniz. DAO mekanizması, projenin topluluk kararlarına göre gelişmesine olanak tanır.",
          "isOpen": false
        },
        {
        ...
        {
          "question": "Risy DAO, ICO sırasında adil dağılımı nasıl sağlıyor?",
          "answer": "Risy DAO, adil dağılımı sağlamak için balina koruma mekanizmalarıyla birlikte Başlangıç DEX Teklifi (iDEXo) modelini uyguluyor. ICO döneminde uygulanan günlük %10 transfer limiti ve geçici %0.75 hodl limiti, balinalar tarafından büyük ölçekli birikimi önlüyor. Bu yaklaşım, erken yatırımcılar için avantajlar sunarken yeni yatırımcıların haklarını da koruyarak, token'ların daha adil bir şekilde dağıtılmasını sağlıyor.",
          "isOpen": false
        }
      ]
    },
